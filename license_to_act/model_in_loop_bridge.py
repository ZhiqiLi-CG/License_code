...
def _case_specs(root: Path) -> list[dict[str, Any]]:
    ...
    return [
        ...
        {
            "bridge_id": "TB_SANITIZE_BOUNDARY_PROGRAM_K5",
            "benchmark": "Terminal-Bench 2.1",
            "task": "sanitize-git-repo",
            "actor_backbone": "action-boundary runtime",
            "harness": "scoped Git boundary program",
            "condition": "boundary-program reproducibility run, K=5",
        ...
        {
            "bridge_id": "TB_WAL_BOUNDARY_PROGRAM_K5",
            "benchmark": "Terminal-Bench 2.1",
            "task": "db-wal-recovery",
            "actor_backbone": "action-boundary runtime",
            "harness": "WAL recovery boundary program",
            "condition": "boundary-program reproducibility run, K=5",
            "comparison_boundary": "runtime_reliability",
            "uses_runtime_only_adapter": "yes",
            "paper_use": "runtime_reliability",
        ...
        {
            "bridge_id": "TB_SQLITE_BOUNDARY_PROGRAM_K5",
            "benchmark": "Terminal-Bench 2.1",
            "task": "sqlite-db-truncate",
            "actor_backbone": "action-boundary runtime",
            "harness": "SQLite truncate boundary program",
            "condition": "boundary-program reproducibility run, K=5",
            "comparison_boundary": "runtime_reliability",
            "uses_runtime_only_adapter": "yes",
            "paper_use": "runtime_reliability",
        ...
        {
            "bridge_id": "TB_LOG_BOUNDARY_PROGRAM_K5",
            "benchmark": "Terminal-Bench 2.1",
            "task": "log-summary-date-ranges",
            "actor_backbone": "action-boundary runtime",
            "harness": "log-summary CSV boundary program",
            "condition": "boundary-program reproducibility run, K=5",
            "comparison_boundary": "runtime_reliability",
            "uses_runtime_only_adapter": "yes",
            "paper_use": "runtime_reliability",
        ...
        {
            "bridge_id": "SF_INVOICE_BOUNDARY_PROGRAM_K5",
            "benchmark": "SkillFlow",
            "task": "task_family_invoice_images",
            "actor_backbone": "action-boundary runtime",
            "harness": "invoice completion-trigger boundary program",
            "condition": "boundary-program reproducibility run, K=5",
            "comparison_boundary": "runtime_reliability",
            "uses_runtime_only_adapter": "yes",
            "paper_use": "runtime_reliability",
        ...
        {
            "bridge_id": "SF_TRAVEL_BOUNDARY_PROGRAM_K5",
            "benchmark": "SkillFlow",
            "task": "task_family_travel_claim_merge",
            "actor_backbone": "action-boundary runtime",
            "harness": "travel-claim completion-trigger boundary program",
            "condition": "boundary-program reproducibility run, K=5",
            "comparison_boundary": "runtime_reliability",
            "uses_runtime_only_adapter": "yes",
            "paper_use": "runtime_reliability",
