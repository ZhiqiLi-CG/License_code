...
def build_comparison_manifest(project_root: str | Path = Path("/data/zhiqi/License")) -> dict[str, Any]:
    ...
    rows = [
        {
            "comparison_id": "M1_FULL_LTA_CLEAN_ANCHORS",
            "comparison_class": "method_condition",
            "paper_role": "main_positive",
            "condition": "Full License-to-Act with GovKernel executable authority",
            "tests": "Does the proposed institution produce stable verifier-backed state changes?",
        ...
        },
        {
            ...
            "tests": "Does a stronger long-context ordinary task agent solve the authority boundary?",
            "evidence_status": "completed",
            "current_result": f"{faithful_passes}/{faithful_trials} official passes",
            "source_data": "stage2_reliability.csv",
        },
        {
            "comparison_id": "A1_PROMPT_ONLY_TEXT_LICENSE",
            "comparison_class": "mechanism_ablation",
            "paper_role": "mechanism_evidence",
            "condition": "Natural-language license text without GovKernel commit control",
            "tests": "Is describing authority in the prompt equivalent to owning the commit channel?",
        ...
        {
            "comparison_id": "A2_NO_POSITIVE_OBLIGATION",
            "comparison_class": "mechanism_ablation",
            "paper_role": "mechanism_evidence",
            "condition": "LTA without OBLIGE transitions for missing artifacts",
        ...
        {
            "comparison_id": "A3_NO_SIDE_EFFECT_BOUNDS",
            "comparison_class": "mechanism_ablation",
            "paper_role": "mechanism_evidence",
            "condition": "LTA without denied-region and side-effect constraints",
            "tests": "Can local success exceed authority by mutating collateral state?",
            "evidence_status": "seed_evidence",
        ...
        },
        {
            ...
            "condition": "Qwen3.8-27B plus GovKernel under the 8192-token endpoint",
            "tests": "Can a real model feed evidence into the executable institution under endpoint pressure?",
            "evidence_status": "completed",
