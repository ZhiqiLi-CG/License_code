...
from license_to_act.model_in_loop_bridge import write_model_in_loop_bridge  # noqa: E402
from license_to_act.paths import artifact_path, project_root  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Export model-in-loop comparison data for the action-boundary paper.")
    ...
    parser.add_argument(
        "--summary",
        type=Path,
        default=artifact_path("paper_results", "lta_model_in_loop_bridge_20260831.json"),
    )
    ...
    print(output["outputs"]["bridge_csv"])
