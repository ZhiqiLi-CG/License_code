...
from license_to_act.mechanism_ablation_panel import write_mechanism_ablation_panel  # noqa: E402
from license_to_act.paths import artifact_path, project_root  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Export mechanism ablation panel data for the LTA paper.")
    ...
    parser.add_argument(
        "--summary",
        type=Path,
        default=artifact_path("paper_results", "lta_mechanism_ablation_panel_20260831.json"),
    )
    ...
    print(output["outputs"]["panel_csv"])
